...
const int SIN_ELEMENTO= 0;
const int CONSTANTE_AUMENTO= 2;
const int CONSTANTE_REDUCCION= 2;
const int VERIFICACION_DE_ELEMENTOS= 4;
...
bool pila_esta_vacia(const pila_t *pila) {
	return (pila->cantidad == SIN_ELEMENTO);
}
...
void* pila_desapilar(pila_t *pila) {
	...
	if(pila->cantidad == (pila->capacidad / VERIFICACION_DE_ELEMENTOS)) {
